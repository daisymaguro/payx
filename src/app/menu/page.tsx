...
import { ArrowLeft, Search, ShoppingBag, Star, MapPin, Plus, Minus, X, Sliders } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen" style={{ background: "#F2F0EB" }}>
      ...
      <div className="relative overflow-hidden px-5 pt-14 pb-8"
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="text-white font-bold text-base flex-1">เมนู</span>
                  ...
                  {SIZES.map((sz, i) => (
                    <button key={sz} onClick={() => setSelectedSize(i)}
                      ...
                      style={selectedSize === i
                        ...
                        : { background: "#D4E9E2", color: "#006241" }}>
                      {sz}<br />
                      <span className="font-normal">{i === 0 ? "" : `+฿${SIZE_EXTRA[i]}`}</span>
                    </button>
                  ))}
                </div>
              </div>
